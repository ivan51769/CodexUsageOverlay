...
图片节奏：封面 → 额度显示 → 直接选择 → 一行组合 → 两行组合 → 边界<br>
...
这次也把一行概览、两行详情分别做成三位置 × 三风格的真实组合预览。新安装默认一行；需要拆开读数时再切两行，字段顺序不变。
...
![直接选择](assets-v1.3.50/03-theme-contrast-1080x1440.png)

### 4. 默认一行｜三位置 × 三风格

![一行组合预览](assets-v1.3.50/05-one-line-matrix-1080x1440.png)

### 5. 两行详情｜三位置 × 三风格

![两行组合预览](assets-v1.3.50/06-two-lines-matrix-1080x1440.png)
