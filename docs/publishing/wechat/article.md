...
作者：拾玖Blues<br>
- 作者：拾玖Blues
阅读原文：https://github.com/ivan51769/CodexUsageOverlay/releases/tag/v1.3.1
...
项目源码、安装说明和校验文件都已公开，Release 页面见下方。

### 获取安装包

**想获取 Windows 安装包，加我微信获得下载链接。** 扫描下方二维码添加“拾玖 Blues”；我会发送 v1.3.1 Release 下载地址和 SHA-256 校验信息，不要求关注、转发或加群。
...
图片来源、尺寸与公开数据状态详见本文开头的配图清单；草稿正文按图1至图5顺序上传。
...
- [x] “阅读原文”指向 v1.3.1 Release；正文主 CTA 为加作者微信获取下载链接，不要求关注、转发或加群。
- [ ] 微信公众号后台已按发布当天规则核对外链、个人微信二维码与加微信获取下载链接、第三方名称、AI 辅助声明和原创声明。
- [x] 未使用“官方工具”“自动重置”“保证到账”等不准确表述。

合规风险：**黄色，发布后台复核后再发**。主要原因是外部 GitHub 链接、个人微信二维码与获取安装包的互动引导、第三方名称和 AI 辅助编辑；此外，“阅读原文”落地的 GitHub README 含可选赞赏二维码，正式发布前需人工确认是否保留。不代表内容违规。
