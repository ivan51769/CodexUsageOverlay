...
**想直接获取 Windows 安装包，私信我获取。** 我会发送 v1.3.1 Release 下载地址和 SHA-256 校验信息；不要求关注、转发或加群。
...
- [x] 所有图片均为本轮最终程序重新导出或基于真实导出图排版。
- [x] 图片中无真实额度、Token、聊天内容、账号、路径、Cookie、验证码、令牌或二维码。
- [x] “阅读原文”指向 v1.3.1 Release；正文主 CTA 为私信获取，不要求关注、转发或加群。
- [ ] 微信公众号后台已按发布当天规则核对外链、第三方名称、AI 辅助声明和原创声明。
- [x] 未使用“官方工具”“自动重置”“保证到账”等不准确表述。

合规风险：**黄色，发布后台复核后再发**。主要原因是外部 GitHub 链接、私信获取安装包的互动引导、第三方名称和 AI 辅助编辑；此外，“阅读原文”落地的 GitHub README 含可选赞赏二维码，正式发布前需人工确认是否保留。不代表内容违规。
