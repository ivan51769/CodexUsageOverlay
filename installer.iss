...
DefaultDirName={localappdata}\Programs\Codex 用量与更新助手
DefaultGroupName=Codex 用量与更新助手
DisableProgramGroupPage=yes
PrivilegesRequired=lowest
OutputDir=dist
OutputBaseFilename=blues19-CodexUsageUpdateAssistant-Setup-{#MyAppVersion}
Compression=lzma2
...
[Icons]
Name: "{group}\Codex 用量与更新助手"; Filename: "{app}\{#MyAppExeName}"
...
Name: "{userdesktop}\Codex 用量与更新助手"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
Name: "{userstartup}\Codex 用量与更新助手"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
