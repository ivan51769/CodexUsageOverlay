...
- 右键齿轮可查看当前版本、立即检查 GitHub 更新，并在发现可信的新稳定版后打开对应 Release 下载页。
...
1. 从 [v1.3.3 Release](https://github.com/ivan51769/CodexUsageOverlay/releases/tag/v1.3.3) 下载 `blues19-CodexUsageOverlay-Setup-1.3.3.exe`。
